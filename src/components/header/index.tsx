                ...
                <div className="flex gap-5 lg:gap-0 flex-col flex-wrap lg:flex-row items-center justify-between">
                    ...
                    <div className="flex group relative flex-col text-lg lg:text-xl font-sans">
                        ...
                        <div className="absolute w-[200px] z-50 top-8 lg:top-12 hidden bg-gray-200 text-gray-700 pt-1 group-hover:block">
                            <Link href={'http://localhost:3000'} className="rounded-t cursor-pointer hover:bg-blue-400 py-2 px-4 block whitespace-no-wrap">Москва</Link>
                            <Link href={'http://spb.localhost:3000'} className="rounded-t cursor-pointer hover:bg-blue-400 py-2 px-4 block whitespace-no-wrap">Санкт-Петербург</Link>
                        </div>
                    </div>
                    <div className="flex flex-col text-lg lg:text-xl font-sans">
                        <div className="font-bold">Рейтинги организаций:</div>
                        <div className="text-primary cursor-pointer">Рейтинг по поверке счетчиков воды в Москве</div>
                    </div>
                </div>
            </Wrapper>
        </header>
