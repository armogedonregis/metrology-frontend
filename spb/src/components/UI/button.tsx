...
export const Button = ({ theme = 'primary', children, onClick }: Props) => {
    ...
    const tertiaryClass = "rounded text-white w-[80px] hover:bg-bgBtn duration-150 transition-all px-2 py-1.5 text-8pxl xl:text-sm bg-bgReq font-medium font-montserrat";
    if(theme === 'primary') {
        return (
