...
export default function Home({ company, block }: ICompanys) {
  ...
  return (
    <>
      ...
      <Hero />
      <Organization title="Поверка счетчиков воды в Санкт-Петербурге – независимый рейтинг организаций, отзывы и цены" />
      <Wrapper>
        <div className="mt-10">
...
export const getStaticProps = async (ctx: NextPageContext) => {
  ...
  const res = await fetch(`${isServer}/api/data/spb/home/output.json`)
