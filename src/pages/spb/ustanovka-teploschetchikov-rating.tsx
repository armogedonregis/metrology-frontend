...
export default function Home({ company, block }: ICompanys) {
  ...
  return (
    <>
      ...
      <Hero />
      <Organization title="Компании по установке теплосчетчиков в Санкт-Петербурге — цены и отзывы" />
      <Wrapper>
        <div className="mt-10">
...
export const getStaticProps = async (ctx: NextPageContext) => {
  ...
  const res = await fetch(`${isServer}/api/data/spb/ustanovka-teploschetchikov-rating/output.json`)
