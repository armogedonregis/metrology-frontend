...
import { HeaderSpbData } from "@/data/headerSPBData";
            ...
            <Wrapper>
                <div className="flex gap-5 lg:gap-0 flex-col flex-wrap lg:flex-row items-center justify-between">
                    ...
                    <div className="flex group relative flex-col text-lg lg:text-xl font-sans">
                        ...
                        <div className="text-primary cursor-pointer">Санкт-Петербург</div>
                    ...
                    <div className="flex group relative flex-col text-lg lg:text-xl font-sans">
                        ...
                        <div className="text-primary cursor-pointer">{HeaderSpbData.find(x => x.url === router.pathname)?.title}</div>
